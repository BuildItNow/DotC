...
@interface MJRefreshCustomHeaderView()
{
    UIView<MJHeaderContentView>*     _contentView;
}

@end

@implementation MJRefreshCustomHeaderView

- (instancetype) initWithView:(UIView<MJHeaderContentView>*) contentView
{
    if(!(self = [super init]))
    {
        return self;
...
- (void) setContentView:(UIView<MJHeaderContentView>*)contentView
{
    ...
    _mjDefaultContent.hidden = _contentView != nil;
}
...
- (CGFloat)validY
{
    if([_contentView respondsToSelector:@selector(validY)])
    {
        return _contentView.validY;
    }
...
- (void)setState:(MJRefreshState)state
{
    ...
    [_contentView onSetState:state];
}

+ (instancetype)header
{
    return STRONG_OBJECT(self, initWithView:nil);
}

+ (instancetype)headerFrom:(UIView<MJHeaderContentView>*)contentView
{
    return STRONG_OBJECT(self, initWithView:contentView);
}
@end